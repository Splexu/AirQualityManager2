/**
 * @file tests.cpp
 * @brief Unit tests for the AirQualityMonitor project.
 * @author Generated by Grok
 * @date 2025-04-22
 *
 * Contains unit tests for key functionalities in MainWindow, AirQualityManager,
 * and MapWidget classes using the Qt Test framework.
 */
 ...
 * @brief Test class for the AirQualityMonitor project.
 *
 * Provides test cases to verify the functionality of the MainWindow,
 * AirQualityManager, and MapWidget classes.
 */
...
private slots:
    /**
     * @brief Initializes resources before all tests.
     */
    void initTestCase() {
    ...
    /**
     * @brief Cleans up resources after all tests.
     */
    ...
    /**
     * @brief Tests the calculateDistance method in MainWindow.
     *
     * Verifies that the distance between (0,0) and (1,1) is approximately 157 km.
     */
    ...
    /**
     * @brief Tests the analyzeMeasurements method in MainWindow.
     *
     * Verifies that the analysis text contains correct min, max, average, and trend.
     */
    ...
    /**
     * @brief Tests the fetchStations method in AirQualityManager.
     *
     * Verifies that the stationsFetched signal is emitted with correct data.
     */
    ...
    /**
     * @brief Tests the latLonToPixel method in MapWidget.
     *
     * Verifies that geographic coordinates are correctly converted to pixel positions.
     */
    ...
    /**
     * @brief Tests the saveStationsToJson method in MainWindow.
     *
     * Verifies that stations are correctly saved to a JSON file.
     */
    void testSaveStationsToJson() {
        ...
        QVERIFY(qAbs(obj["longitude"].toDouble() - 21.0) <